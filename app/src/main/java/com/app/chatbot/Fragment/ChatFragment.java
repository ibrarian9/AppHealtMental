...
import com.app.chatbot.ProfileDoctorActivity;
...
public class ChatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name = viewRoot.findViewById(R.id.tvNameDoc);
        Bundle bundle = this.getArguments();
        String getNama = bundle.getString("name");
        name.setText(getNama);

        // Intent Profile
        intent = new Intent(getActivity(), ProfileDoctorActivity.class);
        btn = viewRoot.findViewById(R.id.btnInfo);
